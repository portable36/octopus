...
- Host proof: [`deploy/restore-drill-host.sh`](../../deploy/restore-drill-host.sh) — restores newest `backups/postgres/daily/*.dump` into `octopus_restore_drill` (live DB untouched).
